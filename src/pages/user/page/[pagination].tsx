...
const TeammatePage = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text: any, res: any, index: any) =>
                <Link href={`/user/${res._id}/view`} className="fw-semibold"><Button type="text" className="text-secondary d-flex align-items-center gap-2 p-0 h-100 bg-transparent" size="small" ><EyeOutlined /></Button></Link>
    ...
    const initData = async () => {
        try {
            ...
            let apiRes = await henceforthApi.Users.list(urlSearchParam.toString());
            setState(apiRes);
        } catch (error) {
                    ...
                    <Row gutter={[20, 20]}>
                        <Col span={24}>
                            <Flex justify="space-between" align="center" gap={10}>
                                <TypographyTitle level={4} className="m-0">Users</TypographyTitle>
